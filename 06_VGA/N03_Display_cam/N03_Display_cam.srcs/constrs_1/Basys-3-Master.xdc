...
# set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports {href}];#Sch name = JB3
# set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {vsync}];#Sch name = JB4
