...
# set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {sw_rgb[1]}]
# set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {sw_rgb[2]}]
...
##Pmod Header JB
# set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {plck}];#Sch name = JB1
# set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {xclk}];#Sch name = JB2
#set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports {JB[2]}];#Sch name = JB3
#set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {JB[3]}];#Sch name = JB4
# set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports {href}];#Sch name = JB7
# set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports {vsync}];#Sch name = JB8
