...
class ram_write_read_test extends ram_base_test;
    ...
    virtual task run_test_seq();
        ...
        seq.num_transation = 100;
        seq.start(env.agt.sqr);
    endtask

endclass

class ram_full_sweep_read_test extends ram_base_test;
    `uvm_component_utils(ram_full_sweep_read_test);
    ...
    virtual task run_test_seq();
        ram_full_sweep_read_sequence seq = ram_full_sweep_read_sequence::type_id::create("seq");
        seq.start(env.agt.sqr);
    endtask
