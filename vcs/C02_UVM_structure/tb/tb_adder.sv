...
class adder_sequence extends uvm_sequence;
    `uvm_object_utils(adder_sequence)  //factory에 adder_sequence 등록 macro
...
class adder_monitor extends uvm_monitor;
    ...
    endtask
endclass  //adder_moniter extends uvm_monitor
...
class adder_test extends uvm_test;
    ...
    virtual task run_phase(uvm_phase phase);
        ...
        a_seq.start(a_env.a_agt.a_sqr);  // seq와 sqr 연결
        // #3000;
...
module tb_adder ();
    ...
    initial begin
        ...
        run_test("adder_test");  //adder_test class 생성
    end
